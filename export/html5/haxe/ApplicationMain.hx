...
class ApplicationMain {
	...
	public static function main() {
		...
		//flash.Lib.setPackage("HaxeFlixel", "Ludum Dare 28", "com.example.myapp", "0.0.1");
		...
		loaders.set("assets/images/player.png", loader);
		total ++;
		...
		var loader:Loader = new Loader();
		loaders.set("assets/images/tiles.png", loader);
		total ++;
		...
		urlLoaders.set("assets/levels/level.tmx", urlLoader);
		total ++;
		...
		var urlLoader:URLLoader = new URLLoader();
		urlLoader.dataFormat = BINARY;
		urlLoaders.set("assets/levels/level0.csv", urlLoader);
		total ++;
		...
		var urlLoader:URLLoader = new URLLoader();
		urlLoader.dataFormat = BINARY;
		urlLoaders.set("assets/music/01.mid", urlLoader);
		total ++;
		...
		var urlLoader:URLLoader = new URLLoader();
		urlLoader.dataFormat = BINARY;
		urlLoaders.set("assets/music/02.mid", urlLoader);
		total ++;
		...
		var urlLoader:URLLoader = new URLLoader();
		urlLoader.dataFormat = BINARY;
		urlLoaders.set("assets/music/03.mid", urlLoader);
		total ++;
		...
		var urlLoader:URLLoader = new URLLoader();
		urlLoader.dataFormat = BINARY;
		urlLoaders.set("assets/music/04.mid", urlLoader);
		total ++;
