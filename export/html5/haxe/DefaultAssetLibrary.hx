...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/levels/level0.csv", __ASSET__assets_levels_level0_csv);
		type.set ("assets/levels/level0.csv", Reflect.field (AssetType, "binary".toUpperCase ()));
		className.set ("assets/music/01.mid", __ASSET__assets_music_01_mid);
		type.set ("assets/music/01.mid", Reflect.field (AssetType, "binary".toUpperCase ()));
		...
		className.set ("assets/music/02.mid", __ASSET__assets_music_02_mid);
		type.set ("assets/music/02.mid", Reflect.field (AssetType, "binary".toUpperCase ()));
		...
		className.set ("assets/music/03.mid", __ASSET__assets_music_03_mid);
		type.set ("assets/music/03.mid", Reflect.field (AssetType, "binary".toUpperCase ()));
		...
		className.set ("assets/music/04.mid", __ASSET__assets_music_04_mid);
		type.set ("assets/music/04.mid", Reflect.field (AssetType, "binary".toUpperCase ()));
		...
		type.set ("assets/levels/level.tmx", Reflect.field (AssetType, "binary".toUpperCase ()));
		path.set ("assets/levels/level0.csv", "assets/levels/level0.csv");
		type.set ("assets/levels/level0.csv", Reflect.field (AssetType, "binary".toUpperCase ()));
		path.set ("assets/music/01.mid", "assets/music/01.mid");
		type.set ("assets/music/01.mid", Reflect.field (AssetType, "binary".toUpperCase ()));
		path.set ("assets/music/01.mp3", "assets/music/01.mp3");
		type.set ("assets/music/01.mp3", Reflect.field (AssetType, "music".toUpperCase ()));
		path.set ("assets/music/02.mid", "assets/music/02.mid");
		type.set ("assets/music/02.mid", Reflect.field (AssetType, "binary".toUpperCase ()));
		path.set ("assets/music/02.mp3", "assets/music/02.mp3");
		type.set ("assets/music/02.mp3", Reflect.field (AssetType, "music".toUpperCase ()));
		path.set ("assets/music/03.mid", "assets/music/03.mid");
		type.set ("assets/music/03.mid", Reflect.field (AssetType, "binary".toUpperCase ()));
		path.set ("assets/music/03.mp3", "assets/music/03.mp3");
		type.set ("assets/music/03.mp3", Reflect.field (AssetType, "music".toUpperCase ()));
		path.set ("assets/music/04.mid", "assets/music/04.mid");
		type.set ("assets/music/04.mid", Reflect.field (AssetType, "binary".toUpperCase ()));
...
class __ASSET__assets_levels_level_tmx extends null { }
class __ASSET__assets_levels_level0_csv extends null { }
class __ASSET__assets_music_01_mid extends null { }
class __ASSET__assets_music_01_mp3 extends null { }
class __ASSET__assets_music_02_mid extends null { }
class __ASSET__assets_music_02_mp3 extends null { }
class __ASSET__assets_music_03_mid extends null { }
class __ASSET__assets_music_03_mp3 extends null { }
class __ASSET__assets_music_04_mid extends null { }
class __ASSET__assets_music_04_mp3 extends null { }
class __ASSET__assets_sounds_step_wav extends null { }
